...
using YarlanAPI.Models;

namespace YarlanAPI.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class MensajesController : ControllerBase
    {
        private readonly YarlanDbContext _context;

        public MensajesController(YarlanDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Mensaje>> PostMensaje(Mensaje mensaje)
        {
          if (_context.Mensajes == null)
          {
              return Problem("Entity set 'YarlanDbContext.Mensajes'  is null.");
          }
